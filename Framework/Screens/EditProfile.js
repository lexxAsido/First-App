                ...
                <ScrollView>
                    <View style={styles.formContainer}>
                        ...
                        <TextInput
                            ...
                            editable={false}
                        />
                        <View style={{ marginTop: 10, borderWidth:3, paddingVertical: 5, backgroundColor:Theme.colors.yellow, borderRadius:20}}>
                            <Text onPress={updateUser} style={{textAlign:"center", fontFamily:Theme.fonts.text900, fontSize:18}}>Update Profile</Text>
                        </View>
                    </View>
                </ScrollView>
            </View>
                ...
                <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)" }}>
                    ...
                    <View style={{ backgroundColor: "#16171D", height: 500, borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => { previewModal(); StartUpload() }}
                            ...
                            <Text style={{ fontFamily: Theme.fonts.text900, fontSize: 16, }}>Upload Image</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
